...
const Page9: React.FC = () => {
  ...
  return (
    <div className="page">
      ...
      It is the province with the highest population density in Sri Lanka. It is home to the country's capital, Sri Jayawardenepura Kotte, as well as the largest city and commercial center, Colombo.</p>
